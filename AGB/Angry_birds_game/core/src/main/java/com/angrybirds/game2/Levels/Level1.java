...
public class Level1 extends Level {
    ...
    public Level1(Core game) {
        super(game, 1, 100); // Initialize with level number and max score
    }

    @Override
    protected void initializeBirds() {
        List<Bird> birds = new ArrayList<>();
        birds.add(new RedBird(130, 160));
        birds.add(new RedBird(50, 100));
        birds.add(new RedBird(80, 100));
    ...
    protected void initializePigs() {
        ...
        pigs.add(new SmallPig(500, 160));
        pigs.add(new SmallPig(560, 130));
        pigs.add(new SmallPig(440, 130));
