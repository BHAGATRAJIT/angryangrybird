...
import com.angrybirds.game2.Birds.BlueBird;
...
public class Level3 extends Level {
    ...
    protected void initializeBirds() {
        ...
        birds.add(new BlueBird(130, 160));
        birds.add(new BlueBird(50, 100));
        birds.add(new BlueBird(90, 100));
    ...
    protected void initializePigs() {
        ...
        pigs.add(new MediumPig(440, 190));
        pigs.add(new MediumPig(560, 160));
        pigs.add(new LargePig(500, 100));
        pigs.add(new SmallPig(500, 190));
    ...
    protected void initializeBlocks() {
        ...
        blocks.add(new WoodBlock(500, 160));
        blocks.add(new WoodBlock(560, 100));
        blocks.add(new GlassBlock(560, 130));
        blocks.add(new GlassBlock(560, 130));

        blocks.add(new StoneBlock(440, 130));
        blocks.add(new StoneBlock(440, 160));
