...
public class Level2Screen implements Screen {
    ...
    public Level2Screen(Core game, Level2 level) { // Corrected constructor parameter
        this.game = game;
        this.level = level; // Store the Level2 instance
    ...
    private void createLaunchButton() {
        ...
        launchButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                // Call launchBird method from the Level2 class using the stored level reference
//                level.launchBird(0); // Example for the first bird
    ...
    public void render(float delta) {
        ...
        batch.begin();
        drawBackground();
        drawGameElements(); // Drawing game elements using the Level2 instance
        batch.end();
    ...
    private void drawBackground() {
        batch.draw(sky, 0, FLOOR_HEIGHT, Gdx.graphics.getWidth(), Gdx.graphics.getHeight() - FLOOR_HEIGHT);
